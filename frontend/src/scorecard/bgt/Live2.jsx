...
export function ScoreCard() {
  ...
  const fetchScoreData = async () => {
    try {
      ...
      const response = await axios.get(`${Baseurl}/api/get_scorecard/53500637`, { headers });
  ...
  const fetchOddsData = async () => {
    try {
      ...
      const response = await axios.get(`http://3.110.27.69/api/api/get_odds/53500637`, { headers });
